...
<html lang="en">
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>asset_admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    ...
    <link
      rel="stylesheet"
      href="<?= base_url(); ?>asset_admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css"
    />
    <!-- iCheck -->
    <link
      rel="stylesheet"
      href="<?= base_url(); ?>asset_admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css"
    />
    <!-- JQVMap -->
    ...
    <link
      rel="stylesheet"
      href="<?= base_url(); ?>asset_admin/plugins/overlayScrollbars/css/OverlayScrollbars.min.css"
    />
    <!-- Daterange picker -->
